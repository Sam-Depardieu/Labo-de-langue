...
constexpr auto qt_meta_stringdata_CLASSVolumeControlDialogENDCLASS = QtMocHelpers::stringData(
    "VolumeControlDialog",
    "on_sliderSystemVolume_valueChanged",
    "",
    "value",
    "on_sliderStudentVolume_valueChanged"
);
...
Q_CONSTINIT const QMetaObject VolumeControlDialog::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSVolumeControlDialogENDCLASS_t,
        ...
        // method 'on_sliderSystemVolume_valueChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        // method 'on_sliderStudentVolume_valueChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>
    >,
    nullptr
...
void VolumeControlDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_sliderSystemVolume_valueChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->on_sliderStudentVolume_valueChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
}
