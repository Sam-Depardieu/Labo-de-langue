...
public:
    ...
    void setupUi(QDialog *InterfaceAudio)
    {
        ...
        horizontalLayoutWidget->setGeometry(QRect(9, 30, 781, 371));
        ...
        horizontalSliderSon->setGeometry(QRect(570, 450, 160, 16));
