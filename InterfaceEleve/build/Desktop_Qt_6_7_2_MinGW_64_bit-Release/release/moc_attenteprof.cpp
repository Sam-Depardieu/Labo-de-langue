...
namespace {
struct qt_meta_stringdata_AttenteProf_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_AttenteProf_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_AttenteProf_t qt_meta_stringdata_AttenteProf = {
    {
        QT_MOC_LITERAL(0, 11),  // "AttenteProf"
        QT_MOC_LITERAL(12, 30),  // "on_label_Loading_linkActivated"
        QT_MOC_LITERAL(43, 0),  // ""
...
Q_CONSTINIT static const uint qt_meta_data_AttenteProf[] = {
...
Q_CONSTINIT const QMetaObject AttenteProf::staticMetaObject = { {
    ...
    qt_meta_stringdata_AttenteProf.offsetsAndSizes,
    qt_meta_data_AttenteProf,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_AttenteProf_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<AttenteProf, std::true_type>,
...
void *AttenteProf::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AttenteProf.stringdata0))
