...
namespace {
struct qt_meta_stringdata_iconEleveGroup_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_iconEleveGroup_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_iconEleveGroup_t qt_meta_stringdata_iconEleveGroup = {
    {
        QT_MOC_LITERAL(0, 14),  // "iconEleveGroup"
        QT_MOC_LITERAL(15, 13),  // "doubleClicked"
        QT_MOC_LITERAL(29, 0)   // ""
    },
    "iconEleveGroup",
    "doubleClicked",
...
Q_CONSTINIT static const uint qt_meta_data_iconEleveGroup[] = {
...
Q_CONSTINIT const QMetaObject iconEleveGroup::staticMetaObject = { {
    ...
    qt_meta_stringdata_iconEleveGroup.offsetsAndSizes,
    qt_meta_data_iconEleveGroup,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_iconEleveGroup_t,
        // Q_OBJECT / Q_GADGET
...
void *iconEleveGroup::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_iconEleveGroup.stringdata0))
