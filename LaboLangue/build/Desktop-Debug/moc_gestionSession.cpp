...
namespace {
struct qt_meta_stringdata_gestionSession_t {
    uint offsetsAndSizes[2];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_gestionSession_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_gestionSession_t qt_meta_stringdata_gestionSession = {
    {
        QT_MOC_LITERAL(0, 14)   // "gestionSession"
    },
    "gestionSession"
};
...
Q_CONSTINIT static const uint qt_meta_data_gestionSession[] = {
...
Q_CONSTINIT const QMetaObject gestionSession::staticMetaObject = { {
    ...
    qt_meta_stringdata_gestionSession.offsetsAndSizes,
    qt_meta_data_gestionSession,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_gestionSession_t,
        // Q_OBJECT / Q_GADGET
...
void *gestionSession::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_gestionSession.stringdata0))
