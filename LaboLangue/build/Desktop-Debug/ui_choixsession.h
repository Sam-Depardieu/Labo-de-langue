...
public:
    ...
    void setupUi(QWidget *choixSession)
    {
        ...
        listeSession->setGeometry(QRect(-10, -10, 381, 571));
        infoSession = new QColumnView(choixSession);
        infoSession->setObjectName("infoSession");
        infoSession->setGeometry(QRect(370, -10, 631, 571));
